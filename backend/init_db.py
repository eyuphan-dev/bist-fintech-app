...
INITIAL_STOCKS = [
    ...
    {"symbol": "ALBRK", "company_name": "Albaraka Türk Katılım Bankası A.Ş.", "is_katilim_compliant": True, "purification_rate": 0.10, "non_compliance_reason": None},
    {"symbol": "BAHKM", "company_name": "Bahadır Kimya Sanayi ve Ticaret A.Ş.", "is_katilim_compliant": True, "purification_rate": 1.20, "non_compliance_reason": None},
    {"symbol": "BEGYO", "company_name": "Batı Ege Gayrimenkul Yatırım Ortaklığı A.Ş.", "is_katilim_compliant": True, "purification_rate": 2.80, "non_compliance_reason": None},
    {"symbol": "BIMAS", "company_name": "BİM Birleşik Mağazalar A.Ş.", "is_katilim_compliant": True, "purification_rate": 1.40, "non_compliance_reason": None},
    {"symbol": "BINBN", "company_name": "Bin Ulaşım ve Akıllı Şehir Teknolojileri A.Ş.", "is_katilim_compliant": True, "purification_rate": 1.60, "non_compliance_reason": None},
    {"symbol": "BORSK", "company_name": "Bor Şeker A.Ş.", "is_katilim_compliant": True, "purification_rate": 0.90, "non_compliance_reason": None},
    {"symbol": "BOSSA", "company_name": "Bossa Ticaret ve Sanayi İşletmeleri T.A.Ş.", "is_katilim_compliant": True, "purification_rate": 2.30, "non_compliance_reason": None},
    {"symbol": "CELHA", "company_name": "Çelik Halat ve Tel Sanayii A.Ş.", "is_katilim_compliant": True, "purification_rate": 1.10, "non_compliance_reason": None},
    {"symbol": "COSMO", "company_name": "Cosmos Yatırım Holding A.Ş.", "is_katilim_compliant": True, "purification_rate": 3.00, "non_compliance_reason": None},
    {"symbol": "DARDL", "company_name": "Dardanel Önentaş Gıda Sanayi A.Ş.", "is_katilim_compliant": True, "purification_rate": 0.70, "non_compliance_reason": None},
    {"symbol": "DOFRB", "company_name": "Dof Robotik Sanayi A.Ş.", "is_katilim_compliant": True, "purification_rate": 1.90, "non_compliance_reason": None},
    {"symbol": "EBEBK", "company_name": "Ebebek Mağazacılık A.Ş.", "is_katilim_compliant": True, "purification_rate": 0.50, "non_compliance_reason": None},
    {"symbol": "EKSUN", "company_name": "Eksun Gıda Tarım Sanayi ve Ticaret A.Ş.", "is_katilim_compliant": True, "purification_rate": 1.30, "non_compliance_reason": None},
    {"symbol": "ESCOM", "company_name": "Escort Teknoloji Yatırım A.Ş.", "is_katilim_compliant": True, "purification_rate": 2.10, "non_compliance_reason": None},
    {"symbol": "FZLGY", "company_name": "Fuzul Gayrimenkul Yatırım Ortaklığı A.Ş.", "is_katilim_compliant": True, "purification_rate": 2.60, "non_compliance_reason": None},
    {"symbol": "GUNDG", "company_name": "Gündoğdu Gıda Süt Ürünleri Sanayi ve Dış Ticaret A.Ş.", "is_katilim_compliant": True, "purification_rate": 0.80, "non_compliance_reason": None},
    {"symbol": "IZFAS", "company_name": "İzmir Fırça Sanayi ve Ticaret A.Ş.", "is_katilim_compliant": True, "purification_rate": 1.00, "non_compliance_reason": None},
    {"symbol": "IZINV", "company_name": "İz Yatırım Holding A.Ş.", "is_katilim_compliant": True, "purification_rate": 2.40, "non_compliance_reason": None},
    {"symbol": "KRGYO", "company_name": "Körfez Gayrimenkul Yatırım Ortaklığı A.Ş.", "is_katilim_compliant": True, "purification_rate": 3.20, "non_compliance_reason": None},
    {"symbol": "KTLEV", "company_name": "Katılımevim Tasarruf Finansman A.Ş.", "is_katilim_compliant": True, "purification_rate": 0.40, "non_compliance_reason": None},
    {"symbol": "KZBGY", "company_name": "Kızılbük Gayırmenkul Yatırım Ortaklığı A.Ş.", "is_katilim_compliant": True, "purification_rate": 2.90, "non_compliance_reason": None},
    {"symbol": "LXGYO", "company_name": "Luxera Gayrimenkul Yatırım Ortaklığı A.Ş.", "is_katilim_compliant": True, "purification_rate": 2.20, "non_compliance_reason": None},
    {"symbol": "MCARD", "company_name": "Metropal Kurumsal Hizmetler A.Ş.", "is_katilim_compliant": True, "purification_rate": 1.50, "non_compliance_reason": None},
    {"symbol": "MPARK", "company_name": "MLP Sağlık Hizmetleri A.Ş. (Medical Park)", "is_katilim_compliant": True, "purification_rate": 1.80, "non_compliance_reason": None},
    {"symbol": "PENGD", "company_name": "Penguen Gıda Sanayi A.Ş.", "is_katilim_compliant": True, "purification_rate": 0.60, "non_compliance_reason": None},
    {"symbol": "YUNSA", "company_name": "Yünsa Yünlü Sanayi ve Ticaret A.Ş.", "is_katilim_compliant": True, "purification_rate": 1.70, "non_compliance_reason": None},

    # --- BIST 100 / BIST Tüm ağırlıklı büyük ölçek hisseler ---
    {"symbol": "THYAO", "company_name": "Türk Hava Yolları A.O.", "is_katilim_compliant": True, "purification_rate": 2.10, "non_compliance_reason": None},
    {"symbol": "EREGL", "company_name": "Ereğli Demir ve Çelik Fabrikaları T.A.Ş.", "is_katilim_compliant": True, "purification_rate": 1.80, "non_compliance_reason": None},
    {"symbol": "TUPRS", "company_name": "Türkiye Petrol Rafinerileri A.Ş.", "is_katilim_compliant": True, "purification_rate": 3.40, "non_compliance_reason": None},
    {"symbol": "ASELS", "company_name": "Aselsan Elektronik Sanayi ve Ticaret A.Ş.", "is_katilim_compliant": True, "purification_rate": 1.20, "non_compliance_reason": None},
    {"symbol": "SISE", "company_name": "Türkiye Şişe ve Cam Fabrikaları A.Ş.", "is_katilim_compliant": True, "purification_rate": 2.50, "non_compliance_reason": None},
    {"symbol": "KCHOL", "company_name": "Koç Holding A.Ş.", "is_katilim_compliant": False, "purification_rate": 0.00,
    ...
    {"symbol": "SAHOL", "company_name": "Hacı Ömer Sabancı Holding A.Ş.", "is_katilim_compliant": False, "purification_rate": 0.00,
    ...
    {"symbol": "GARAN", "company_name": "Türkiye Garanti Bankası A.Ş.", "is_katilim_compliant": False, "purification_rate": 0.00,
     "non_compliance_reason": "Faiz bazlı mevduat bankacılığı faaliyeti yürütmektedir."},
    {"symbol": "AKBNK", "company_name": "Akbank T.A.Ş.", "is_katilim_compliant": False, "purification_rate": 0.00,
     "non_compliance_reason": "Faiz bazlı mevduat bankacılığı faaliyeti yürütmektedir."},
    {"symbol": "FROTO", "company_name": "Ford Otomotiv Sanayi A.Ş.", "is_katilim_compliant": True, "purification_rate": 1.50, "non_compliance_reason": None},
    {"symbol": "TOASO", "company_name": "Tofaş Türk Otomobil Fabrikası A.Ş.", "is_katilim_compliant": True, "purification_rate": 1.70, "non_compliance_reason": None},
    {"symbol": "SASA", "company_name": "Sasa Polyester Sanayi A.Ş.", "is_katilim_compliant": True, "purification_rate": 0.90, "non_compliance_reason": None},
    {"symbol": "HEKTS", "company_name": "Hektaş Ticaret T.A.Ş.", "is_katilim_compliant": True, "purification_rate": 0.60, "non_compliance_reason": None},
    {"symbol": "ENKAI", "company_name": "Enka İnşaat ve Sanayi A.Ş.", "is_katilim_compliant": True, "purification_rate": 4.20, "non_compliance_reason": None},
    {"symbol": "PETKM", "company_name": "Petkim Petrokimya Holding A.Ş.", "is_katilim_compliant": True, "purification_rate": 2.00, "non_compliance_reason": None},
    {"symbol": "OYAKC", "company_name": "Oyak Çimento A.Ş.", "is_katilim_compliant": True, "purification_rate": 1.10, "non_compliance_reason": None},
    {"symbol": "MGROS", "company_name": "Migros Ticaret A.Ş.", "is_katilim_compliant": False, "purification_rate": 0.00,
