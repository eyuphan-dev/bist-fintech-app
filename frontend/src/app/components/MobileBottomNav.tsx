...
import {
  ...
  ShoppingBasket, Rewind, Trophy, Calculator, Crown, ListChecks, Store, Swords,
} from "lucide-react";
...
const MENU_GROUPS: {
...
}[] = [
  {
    ...
    links: [
      ...
      { href: "/sepetler", label: "Sepetler & Pazaryeri", icon: ShoppingBasket },
      ...
      { href: "/takvim", label: "Takvim (Makro, Bilanço, KAP)", icon: CalendarDays },
    ],
  },
  {
    title: "Hesabım",
